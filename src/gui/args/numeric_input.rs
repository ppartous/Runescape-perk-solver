...
use iced::widget::{self, button, column, row, svg, text_input, vertical_space};
        ...
        + iced_native::widget::svg::StyleSheet,
{
    ...
    fn view(&self, _state: &Self::State) -> Element<Event, Renderer> {
        let button = |icon, on_press| {
            button(svg(icon).width(Length::Fill).height(Length::Fill))
                .width(20)
                .height(15)
                .padding(2)
                .on_press(on_press)
        ...
        row![
            ...
            column![
                button(
                    iced_native::svg::Handle::from_memory(
                        include_bytes!("../../../images/up arrow.svg").as_ref()
                    ),
                ...
                button(
                    iced_native::svg::Handle::from_memory(
                        include_bytes!("../../../images/down arrow.svg").as_ref()
                    ),
